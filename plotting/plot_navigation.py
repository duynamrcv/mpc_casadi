...
def store_data():
    ...
    import scipy.io
    scipy.io.savemat('/home/duynam/vast_ws/src/mpc_casadi/data/nmpc.mat', dict(ans=poses))
    scipy.io.savemat('/home/duynam/vast_ws/src/mpc_casadi/data/ref.mat', dict(ans=traj))
